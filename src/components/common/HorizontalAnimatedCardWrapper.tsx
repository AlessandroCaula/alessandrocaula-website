import type { HorizontalAnimatedCardWrapperProps } from "@/types";
...
// 
const HorizontalAnimatedCardWrapper = ({ children, xInitialOffset = 0 }: HorizontalAnimatedCardWrapperProps) => {
  return (
    <motion.div
